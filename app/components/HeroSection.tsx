			...
			<div className="relative z-10 max-w-5xl mx-auto px-4">
				<div className="text-center space-y-6">
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						<div className="flex flex-col items-center gap-4">
							<div className="flex items-center gap-3">
								...
								<h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-400">Aspiring Software Developer</h2>
								<span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
							</div>
							<p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
								Enthusiastic developer focused on building efficient internal tools, workflow automation, and data-driven applications
							</p>
						</div>

						{/* Tech Stack Pills */}
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['Python', 'JavaScript', 'C#', 'React.js', 'Node.js', 'MongoDB', 'MySQL', 'Firebase'].map((tech) => (
								<span
									key={tech}
					...
					<div className="flex justify-center gap-4 sm:gap-6 mt-8 sm:mt-12">
						{[
							{ name: 'GitHub', icon: '🐙', href: 'https://github.com/yourgithub' },
							{ name: 'LinkedIn', icon: '💼', href: 'https://linkedin.com/in/yourlinkedin' },
							{ name: 'Email', icon: '✉️', href: 'mailto:wh44554@gmail.com' },
						].map((social) => (
							<a key={social.name} href={social.href} className="group relative p-2 sm:p-3 hover:text-blue-400 transition-colors" aria-label={social.name} target="_blank" rel="noopener noreferrer">
